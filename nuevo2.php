...
<div class="container">
    ...
    <div id="menu" style="display:none;">
        ...
        <div class="menu">
            <div class="menu-item">
                <img src="pique.png" alt="Pique Macho">
                <h3>Pique Macho</h3>
                <p>Precio: 50.00bs</p>
                <form method="POST">
            ...
            <div class="menu-item">
                <img src="charque.png" alt="Charque">
                <h3>Charque</h3>
                <p>Precio: 50.00bs</p>
                <form method="POST">
            ...
            <div class="menu-item">
                <img src="escabeche.jpg" alt="Escabeche">
                <h3>Escabeche</h3>
                <p>Precio: 50.00bs</p>
                <form method="POST">
            ...
            <div class="menu-item">
                <img src="chicharron.jpg" alt="Chicharrón">
                <h3>Chicharrón</h3>
                <p>Precio: 70.00bs</p>
                <form method="POST">
            ...
            <div class="menu-item">
                <img src="fricase.jpg" alt="Fricasé">
                <h3>Fricasé</h3>
                <p>Precio: 25.00bs</p>
                <form method="POST">
